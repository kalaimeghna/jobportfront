  ...
  return (
    <aside className="flex h-full w-full flex-col bg-white border-r border-gray-200">
      ...
      <nav className="flex-1 space-y-1 overflow-y-auto p-4">
        ...
        <NavLink to="/companies" className={linkClass} onClick={onClose}>
        ...
        {(role === "employer" || role === "admin") && (
          <>
            ...
            <p className="px-4 text-[10px] font-bold uppercase text-gray-400">Employer Tools</p>
            <NavLink to="/jobs/create" className={linkClass} onClick={onClose}>
              <FaPlusCircle /> Post Job
            </NavLink>
            <NavLink to="/jobs/my" className={linkClass} onClick={onClose}>
              <FaBriefcase /> My Jobs
            </NavLink>
            ...
            <NavLink to="/company/profile" className={linkClass} onClick={onClose}>
        ...
        {role === "jobseeker" && (
          <>
            <div className="my-3 border-t border-gray-200" />
            <p className="px-4 text-[10px] font-bold uppercase text-gray-400">Candidate Tools</p>
            <NavLink to="/applications" className={linkClass} onClick={onClose}>
              <FaHistory /> My Applications
            </NavLink>
            <NavLink to="/recommended-jobs" className={linkClass} onClick={onClose}>
        ...
        {/* ================= PERSONAL PROFILE ================= */}
        <div className="my-3 border-t border-gray-200" />
        <p className="px-4 text-[10px] font-bold uppercase text-gray-400">Account</p>
        <NavLink 
          to={role === "employer" ? "/employer/profile" : "/profile"} 
          className={linkClass} 
          onClick={onClose}
        >
          <FaUser /> My Personal Profile
        </NavLink>
      </nav>
